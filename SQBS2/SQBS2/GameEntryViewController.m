...
- (void)displayCurrentGame {
    ...
    if ((selectedGameIndex < 0) || (selectedGameIndex >= [[documentDelegate gameList] count])) {
        ...
        if ((teamA_index < 0) || (teamA_index > [teamDictionaryList count])) {
            // put up warning
            [self displayAlertMessage:@"File inconsistancy: Team A is not valid." InformationText:[NSString stringWithFormat:@"Team Index: %li out of range {0 - %i}.", teamA_index, ([teamDictionaryList count] - 1)]];
            teamA_index = -1;
            teamA_valid = FALSE;
        } else {
        ...
        if ((teamB_index < 0) || (teamB_index > [teamDictionaryList count])) {
            // put up warning
            [self displayAlertMessage:@"File inconsistancy: Team B is not valid." InformationText:[NSString stringWithFormat:@"Team Index: %li out of range {0 - %i}.", teamB_index, ([teamDictionaryList count] - 1)]];
            teamB_index = -1;
            teamB_valid = FALSE;
        } else {
