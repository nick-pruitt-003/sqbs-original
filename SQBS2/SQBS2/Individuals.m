...
- (NSString *)description {
    NSMutableString *record = [NSMutableString stringWithFormat:@"Player/Team: %@/%@, gp: %.2f, 0/1/2/3: {%li, %li, %li, %li}, pts/tuh: {%li, %li}, index:%li P:%li", playerName, teamName, gamesPlayed, q0, q1, q2, q3, points, tossUpsHeard, position, teamIndex];
