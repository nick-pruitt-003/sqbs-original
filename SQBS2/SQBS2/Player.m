...
-(NSString *)createPlayerRecord {
    return [NSString stringWithFormat:@"%@%li%@%@%@%li%@%li%@%li%@%li%@%li", kLineEndCharacter, playerIndex,
...
-(NSString *)description {
    return [NSString stringWithFormat:@"Player: %li, {%@, %li, %li, %li, %li, %li}", playerIndex, gamesPlayed, question0Count, question1Count, question2Count, question3Count, points];
}
