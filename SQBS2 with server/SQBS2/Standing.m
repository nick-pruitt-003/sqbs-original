...
- (NSString *)description {
    NSMutableString *record = [NSMutableString stringWithFormat:@"Team: %@, W/L/T: {%i, %i, %i}, pf/pa: {%i, %i}, pos: %i, strength: %0.2f", teamName, win, loss, tie, pointsFor, pointsAgainst, position, strengthStanding];
