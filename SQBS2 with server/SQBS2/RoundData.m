...
- (NSString *)description {
    NSMutableString *record = [NSMutableString stringWithFormat:@"gp: %i, pts: %i, TUH/TUPts: {%i, %i}, bh/bp: {%i, %i}, bbh/bbp: {%i, %i}", gamesPlayed, points, tossUpsHeard, tossUpsPoints, bonusHeard, bonusPoints, bouncebacksHeard, bouncebacksPoints];
